    ...
    function buildHTML(snapshots) {
        ...
        snapshots.docs.forEach((listval) => {
            ...
            if (val.photo == '') {
                ...
                html = html + '<td class="text-center"><img class="img-circle img-size-32 mr-2" style="width:60px;height:60px;" src="' + photo + '" onerror="this.onerror=null;this.src=\'' + placeholderImage + '\'" alt="image"></td>';
            }

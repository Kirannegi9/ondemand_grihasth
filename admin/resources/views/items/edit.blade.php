...
$('#item_subcategory').html('<option value="">{{trans("Select Subcategory")}}</option>');


await database.collection('vendor_subcategories')
    .where('publish', '==', true)
    .get()
    .then(async function (snapshots) {
        ...
        snapshots.docs.forEach((listval) => {
            ...
            if ($('#item_category').val() == data.category_id) {

                if (data.id == product.subcategoryID) {
                    $('#item_subcategory').append($("<option selected></option>")
                        .attr("value", data.id)
                    ...
                    $.each(variants, function (index, variant) {
                        ...
                        if (item_attributeX) {
                            ...
                            if (variant_info[0]) {
                                ...
                                variant_dis_price = variant_info[0].variant_dis_price || '';
                        ...
                        html += '<input type="number" id="dis_price_' + variant + '" value="' + variant_dis_price + '" min="0" class="form-control" placeholder="Optional">';

                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row width-100">
                                ...
                                <label class="col-12 control-label">IFSC Code</label>

                                <div class="col-12">

                                    <input type="text" name="ifsc_code" class="form-control" id="ifscCode" placeholder="e.g., SBIN0001234">
                            ...
                            <div class="form-group row width-100">
                                ...
                                <label class="col-12 control-label">Account Type</label>
        ...
        await database.collection('users').where("vendorID", "==", vendorId).get().then(async function (snapshotss) {
            ...
            if (snapshotss.docs[0]) {
                ...
                if (user_data.userBankDetails) {
                    ...
                    $('#ifscCode').val(user_data.userBankDetails.ifscCode);

                    $('#accountType').val(user_data.userBankDetails.accountType);

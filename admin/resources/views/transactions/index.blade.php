...
<script>
    ...
    async function buildHTML(val) {
        ...
        if (val.payment_method) {
            ...
            } else if (val.payment_method && (val.payment_method.toLowerCase() == "wallet" || (val.payment_method.toLowerCase().includes("emart") && val.payment_method.toLowerCase().includes("wallet")))) {

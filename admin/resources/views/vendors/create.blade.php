                        ...
                        <div class="vendor_payout_create-inner">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <select id='vendor_cuisines' class="form-control" multiple required >
                                ...
                                <div class="form-group row"> 
                                    ...
                                    <div class="col-md-6">
                                        <div class="phone-box position-relative" id="phone-box">
                                            ...
                                            <?php $selected = ($valuecy->code == "IN") ? "selected" : ""; ?>
...
<script src="https://cdn.jsdelivr.net/npm/choices.js/public/assets/scripts/choices.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(async function() {
            ...
            // Initialize vendor variables for create mode
            vendorOwnerOnline = false;
            photo = "";
            vendorOwnerId = "";
            ownerId = "";
    ...
    snapshots.docs.forEach((listval) => {
        ...
        // Initialize empty array for create mode
...
database.collection('vendor_categories')
    ...
    .catch((err) => {
        ...
        $(".save-form-btn").click(async function() {
            ...
            // Try multiple methods to get selected cuisines
            var cuisines = null;
            
            // Method 1: Choices.js getValue()
            if (window.cuisinesInstance) {
                cuisines = window.cuisinesInstance.getValue(true);
                console.log('Choices.js getValue():', cuisines);
            }
            
            // Method 2: jQuery val() as fallback
            if (!cuisines || cuisines.length === 0) {
                cuisines = $("#vendor_cuisines").val();
                console.log('jQuery val() fallback:', cuisines);
            }
            
            // Method 3: Check selected items in Choices.js DOM
            if (!cuisines || cuisines.length === 0) {
                var selectedItems = $('.choices__list--multiple .choices__item[data-value]');
                if (selectedItems.length > 0) {
                    cuisines = selectedItems.map(function() { return $(this).data('value'); }).get();
                    console.log('DOM selected items:', cuisines);
                }
            }
            
            // Method 4: Direct check of the original select element
            if (!cuisines || cuisines.length === 0) {
                var originalSelect = document.getElementById('vendor_cuisines');
                if (originalSelect && originalSelect.selectedOptions) {
                    cuisines = Array.from(originalSelect.selectedOptions).map(option => option.value);
                    console.log('Original select element:', cuisines);
                }
            }
            
            console.log('Final cuisines value:', cuisines);
            
            var categoryTitle = [];
            if (cuisines && cuisines.length > 0) {
                categoryTitle = cuisines.map(function(value) {
                    var choice = window.cuisinesInstance._store.choices.find(choice => choice.value === value);
            ...
            if (vendorname == '') {
                ...
                console.log('Validation failed - cuisines:', cuisines); // Debug log
                $(".error_top").show();
                $(".error_top").html("");

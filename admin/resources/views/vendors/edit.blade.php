                        ...
                        <div class="vendor_payout_create-inner">                           
                            ...
                            <fieldset>
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <select id='vendor_cuisines' class="form-control" multiple>
                            ...
                            <fieldset id="services_feature">
                                <legend>{{trans('lang.services')}}</legend>
                                <div class="form-group row">

                                    <div class="form-check width-100">
                                        <input type="checkbox" id="Instant_Pickup">
                                        <label class="col-3 control-label" for="Instant_Pickup">Instant Pickup (Ready Stock)</label>
                                    </div>
                                    <div class="form-check width-100">
                                        <input type="checkbox" id="Scheduled_Pickup">
                                        <label class="col-3 control-label" for="Scheduled_Pickup">Scheduled Pickup (Time Slot Based)</label>
                                    </div>
                                    <div class="form-check width-100">
                                        <input type="checkbox" id="Curbside_Pickup">
                                        <label class="col-3 control-label" for="Curbside_Pickup">Curbside Pickup (Drive-through style)</label>
                                    </div>
                                    <div class="form-check width-100">
                                        <input type="checkbox" id="Walk_in_Shopping">
                                        <label class="col-3 control-label" for="Walk_in_Shopping">Walk-in Shopping + Self Checkout</label>
                                    </div>

                                    <div class="form-check width-100">
                                        <input type="checkbox" id="Bulk_Project_Pickup">
                                        <label class="col-3 control-label" for="Bulk_Project_Pickup">Bulk/Project Pickup (for contractors)</label>
                                    </div>

                                    <div class="form-check width-100">
                                        <input type="checkbox" id="Click_Collect_Promotions">
                                        <label class="col-3 control-label" for="Click_Collect_Promotions">Click & Collect Promotions (special offers for takeaway)</label>
                                    </div>

                                    <div class="form-check width-100">
                                        <input type="checkbox" id="Pre_Order_Store_Pickup">
                                        <label class="col-3 control-label" for="Pre_Order_Store_Pickup">Pre-Order & Store Pickup</label>
                                    </div>

                                    <div class="form-check width-100">
                                        <input type="checkbox" id="Mixed_Cart_Option">
                                        <label class="col-3 control-label" for="Mixed_Cart_Option">Mixed Cart Option (Delivery + Pickup)</label>
                                    </div>

                                    <div class="form-check width-100">
                                        <input type="checkbox" id="Take_Reservation">
                                        <label class="col-3 control-label" for="Take_Reservation">Take Reservation</label>
                                    </div>

                                    <div class="form-check width-100">
                                        <input type="checkbox" id="Physical_Cosmos_Color">
                                        <label class="col-3 control-label" for="Physical_Cosmos_Color">Physical Cosmos & Colour Suggestions</label>
                                    </div>

                                    <div class="form-check width-100">
                                        <input type="checkbox" id="Take_Away_Facilities">
                                        <label class="col-3 control-label" for="Take_Away_Facilities">Take Away Facilities</label>
                                    </div>

                                    <div class="form-check width-100">
                                        <input type="checkbox" id="Product_Addition_Removal">
                                        <label class="col-3 control-label" for="Product_Addition_Removal">Product Addition and Removal Facilities</label>
                                    </div>

                                    <div class="form-check width-100">
                                        <input type="checkbox" id="One_On_One_Consultation">
                                        <label class="col-3 control-label" for="One_On_One_Consultation">One on One Consultation</label>
                                    </div>

                                </div>
                            </fieldset>

                            <fieldset id="is_dine_in_feature">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        ref_sections.get().then(async function (snapshots) {
            ...
            sections_list.forEach((section) => {
                $('#section_id').append($("<option></option>")
                    ...
                    .attr("data-type", section.serviceTypeFlag)
                    .attr("data-commission", JSON.stringify(section.adminCommission))
                    .text(section.name));
            });
        })

        // Add section change handler to show/hide features
        $(document).on('change', '#section_id', function() {
            var selectedSection = $(this).val();
            var selectedData = sections_list.find(section => section.id === selectedSection);
            
            if (selectedData) {
                if (selectedData.dine_in_active == true) {
                ...
                if (selectedData.serviceTypeFlag == "ecommerce-service") {
        ...
        ref.get().then(async function (snapshots) {
            ...
            for (var key in vendor.filters) {
                ...
                if (key == "Instant Pickup (Ready Stock)" && vendor.filters[key] == "Yes") {
                    $("#Instant_Pickup").prop("checked", true);
                }
                if (key == "Scheduled Pickup (Time Slot Based)" && vendor.filters[key] == "Yes") {
                    $("#Scheduled_Pickup").prop("checked", true);
                }
                if (key == "Curbside Pickup (Drive-through style)" && vendor.filters[key] == "Yes") {
                    $("#Curbside_Pickup").prop("checked", true);
                }
                if (key == "Walk-in Shopping + Self Checkout" && vendor.filters[key] == "Yes") {
                    $("#Walk_in_Shopping").prop("checked", true);
                }
                if (key == "Bulk/Project Pickup (for contractors)" && vendor.filters[key] == "Yes") {
                    $("#Bulk_Project_Pickup").prop("checked", true);
                }
                if (key == "Click & Collect Promotions (special offers for takeaway)" && vendor.filters[key] == "Yes") {
                    $("#Click_Collect_Promotions").prop("checked", true);
                }
                if (key == "Pre-Order & Store Pickup" && vendor.filters[key] == "Yes") {
                    $("#Pre_Order_Store_Pickup").prop("checked", true);
                }
                if (key == "Mixed Cart Option (Delivery + Pickup)" && vendor.filters[key] == "Yes") {
                    $("#Mixed_Cart_Option").prop("checked", true);
                }
                if (key == "Take Reservation" && vendor.filters[key] == "Yes") {
                    $("#Take_Reservation").prop("checked", true);
                }
                if (key == "Physical Cosmos & Colour Suggestions" && vendor.filters[key] == "Yes") {
                    $("#Physical_Cosmos_Color").prop("checked", true);
                }
                if (key == "Take Away Facilities" && vendor.filters[key] == "Yes") {
                    $("#Take_Away_Facilities").prop("checked", true);
                }
                if (key == "Product Addition and Removal Facilities" && vendor.filters[key] == "Yes") {
                    $("#Product_Addition_Removal").prop("checked", true);
                }
                if (key == "One on One Consultation" && vendor.filters[key] == "Yes") {
                    $("#One_On_One_Consultation").prop("checked", true);
                }
    ...
    snapshots.docs.forEach((listval) => {
        ...
        // vendor.categoryID is already an array in your DB
        let selectedCuisines = vendor.categoryID || []; 

        if (selectedCuisines.includes(data.id)) {
    ...
    if (window.cuisinesInstance) {
    window.cuisinesInstance.destroy();
}

const cuisines = new Choices('#vendor_cuisines', {
    removeItemButton: true,
    placeholder: true,
    placeholderValue: "{{ trans('lang.select_category') }}",
    duplicateItemsAllowed: false,
    shouldSort: false
});

// 🧹 clear any existing DOM options before adding
cuisines.clearStore();

window.cuisinesInstance = cuisines;
...
database.collection('vendor_categories')
    ...
    .then((snapshots) => {
        ...
        snapshots.docs.forEach((listval) => {
            var data = listval.data();
            let isSelected = selectedCuisines.includes(data.id);
        ...
        cuisines.clearChoices(); // ✅ Fix duplicates
        cuisines.setChoices(choices, 'value', 'label', true);
    })
    .catch((err) => {
        ...
        return $(this).text();
            ...
            if (dine_in_active == false) {
                // Only reset if the section doesn't support takeaway
                // enabledDiveInFuture = false; // Commented out to preserve checkbox value
                // vendorCost = ""; // Commented out to preserve cost value
                // openDineTime = ""; // Commented out to preserve opening time
                // closeDineTime = ""; // Commented out to preserve closing time
                vendor_menu_photos = [];
            }
            ...
            var Instant_Pickup = "No";
            if ($("#Instant_Pickup").is(":checked")) {
                Instant_Pickup = "Yes";
            }
            var Scheduled_Pickup = "No";
            if ($("#Scheduled_Pickup").is(':checked')) {
                Scheduled_Pickup = "Yes";
            }
            var Curbside_Pickup = "No";
            if ($("#Curbside_Pickup").is(':checked')) {
                Curbside_Pickup = "Yes";
            }
            var Walk_in_Shopping = "No";
            if ($("#Walk_in_Shopping").is(':checked')) {
                Walk_in_Shopping = "Yes";
            }
            var Bulk_Project_Pickup = "No";
            if ($("#Bulk_Project_Pickup").is(':checked')) {
                Bulk_Project_Pickup = "Yes";
            }
            var Click_Collect_Promotions = "No";
            if ($("#Click_Collect_Promotions").is(':checked')) {
                Click_Collect_Promotions = "Yes";
            }
            var Pre_Order_Store_Pickup = "No";
            if ($("#Pre_Order_Store_Pickup").is(':checked')) {
                Pre_Order_Store_Pickup = "Yes";
            }
            var Mixed_Cart_Option = "No";
            if ($("#Mixed_Cart_Option").is(':checked')) {
                Mixed_Cart_Option = "Yes";
            }
            var Take_Reservation = "No";
            if ($("#Take_Reservation").is(':checked')) {
                Take_Reservation = "Yes";
            }
            var Physical_Cosmos_Color = "No";
            if ($("#Physical_Cosmos_Color").is(':checked')) {
                Physical_Cosmos_Color = "Yes";
            }
            var Take_Away_Facilities = "No";
            if ($("#Take_Away_Facilities").is(':checked')) {
                Take_Away_Facilities = "Yes";
            }
            var Product_Addition_Removal = "No";
            if ($("#Product_Addition_Removal").is(':checked')) {
                Product_Addition_Removal = "Yes";
            }
            var One_On_One_Consultation = "No";
            if ($("#One_On_One_Consultation").is(':checked')) {
                One_On_One_Consultation = "Yes";
            }

            var filters_new = {
                "Instant Pickup (Ready Stock)": Instant_Pickup,
                "Scheduled Pickup (Time Slot Based)": Scheduled_Pickup,
                "Curbside Pickup (Drive-through style)": Curbside_Pickup,
                "Walk-in Shopping + Self Checkout": Walk_in_Shopping,
                "Bulk/Project Pickup (for contractors)": Bulk_Project_Pickup,
                "Click & Collect Promotions (special offers for takeaway)": Click_Collect_Promotions,
                "Pre-Order & Store Pickup": Pre_Order_Store_Pickup,
                "Mixed Cart Option (Delivery + Pickup)": Mixed_Cart_Option,
                "Take Reservation": Take_Reservation,
                "Physical Cosmos & Colour Suggestions": Physical_Cosmos_Color,
                "Take Away Facilities": Take_Away_Facilities,
                "Product Addition and Removal Facilities": Product_Addition_Removal,
                "One on One Consultation": One_On_One_Consultation
            };

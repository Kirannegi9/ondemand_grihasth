                ...
                await database.collection('users').where("id", "==",id).get().then(async function (snapshots) {
                    snapshots.docs.forEach((listval) => {
                        ...
                        if (user.userBankDetails) {
                            ...
                            if (user.userBankDetails.ifscCode != undefined) {
                                $("#ifscCode").val(user.userBankDetails.ifscCode);
                            }
                            if (user.userBankDetails.accountType != undefined) {
                                $("#accountType").val(user.userBankDetails.accountType);
                            }

...
*/
//clear database
Route::get('/clear-users', [FirestoreController::class, 'clearUsers']);

// clear any collection dynamically
Route::get('/clear/{name}', [FirestoreController::class, 'clearCollection']);
...
Route::middleware(['permission:categories,categories.create'])->group(function () {
    ...
    Route::get('/subcategories/edit/{id}', [App\Http\Controllers\SubCategoryController::class, 'edit'])->name('subcategories.edit');

    Route::get('/subcategories/create', [App\Http\Controllers\SubCategoryController::class, 'create'])->name('subcategories.create');

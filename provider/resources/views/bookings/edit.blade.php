...
@section('content')
    ...
    <div class="page-wrapper printableArea">
            ...
            <div class="col-md-12 non-printable">
                <div class="print-top  mt-3">
                    <div class="text-right print-btn non-printable">
                        <a href="{{route("bookings.print",$id)}}"><i class="fa fa-print"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="order_detail-top-box">
                                        ...
                                        <div class="form-group row widt-100 gendetail-col" id="start_time_div"
                                             style="display:none">
                                            <label class="col-12 control-label"><strong>{{trans('lang.start_time')}}
                                                    : </strong><span class="start_time"></span></label>
                                        </div>
                                        <div class="form-group row widt-100 gendetail-col" id="end_time_div"
                                             style="display:none">
                                        ...
                                        <div class="d-flex mb-2 d-none total_time_div">
                                            <div class="row widt-100 gendetail-col d-none" id="total_time">
                                                <label class="col-12 control-label"><strong
                                                            class="font-weight-bold mr-5">{{trans('lang.total_time')}}
                                                        : </strong><span id="timer"
                                                                         class="text-danger font-weight-bold">00:00:00</span>
                                                </label>
                                            </div>
                                            <div class="ml-auto stop_time_div d-none">
                                                <button class="btn btn-sm btn-danger stop_timer_btn">{{trans('lang.stop_time')}}</button>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-7">
                                                <select id="order_status" class="form-control">
                                                    ...
                                                    <option value="Order Assigned"
                                                            id="order_assigned">{{ trans('lang.order_assigned')}}
                                                    </option>
                                                    <option value="Order Ongoing"
                                                            id="order_ongoing">{{ trans('lang.order_ongoing')}}
                                                    </option>
                                        ...
                                        <div class="form-group row width-100 mt-3">
                                            ...
                                            <div class="d-flex" id="extra_charge">
                                                ...
                                                <button type="button"
                                                        class="btn btn-primary save_order_btn show_popup non-printable ml-3">
                    ...
                    <form class="">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group form-check row width-100 text-left">
                                ...
                                <div class="form-group form-check row width-100 text-left">
                                    ...
                                    <label for="assign_order_worker"
                                           class="form-check-label">{{trans("lang.assign_to_worker")}}</label>
                                    <div id="select_radio_err" style="color:red"></div>
                                </div>
                                <div class="form-group row width-100 text-left" id="worker_list_div"
                                     style="display:none">
                                    <div class="col-12">
...
@section('scripts')
    ...
    <script>
            ...
            ref.get().then(async function (snapshots) {
                ...
                if (order.workerId != '' && order.workerId != null && order.workerId != undefined) {
                    ...
                    if (workerDetail == '' || workerDetail == undefined) {
                        ...
                        var ratingHtml = '<span class="badge badge-success text-white ml-auto sp_badge" ><i class="fa fa-star fstar" ></i>' + (rating).toFixed(1) + '</span>';
                ...
                if (order.hasOwnProperty('provider') && order.provider.hasOwnProperty('id')) {
                    ...
                    if (providerServiceDetail == '' || providerServiceDetail == undefined) {
                        $('.service-title').html("{{trans('lang.unknown')}}");
                        $('.service_details').removeClass('redirecttopage');
                        $('.service-img').attr('src', place_image);
        ...
        $('#extra-charge-btn').on('click', function () {
            ...
            /*if (priceUnit == 'Hourly') {
                extraChargePaymentStatus = true; // do not add var keyword before extraChargePaymentStatus it was defined globally
        ...
        $('.stop_timer_btn').on('click', function () {
            ...
            var totalTimeInHours = parseFloat(timeDiff / (1000 * 60 * 60)).toFixed(2);
        ...
        $(".save_order_btn").click(async function () {
            ...
            if (orderStatus == "Order Accepted") {
                ...
                database.collection('provider_orders').doc(id).update({'status': orderStatus}).then(async function (result) {
                    refundAmount();
                })
            } else if (orderStatus == "Order Assigned") {
        ...
        function getUserReview(bookingOrder, reviewAttr) {
            ...
            refUserReview.get().then(async function (userreviewsnapshot) {
                ...
                providerRate = buildProviderRatingsAndReviewsHTML(bookingOrder, userreviewsnapshot);
                workerRate = buildWorkerRatingsAndReviewsHTML(bookingOrder, userreviewsnapshot);
                if (userreviewsnapshot.docs.length > 0) {
                    jQuery("#customers_rating_and_review").append(reviewHTML);
                    jQuery("#rating_provider").append(providerRate);
                    jQuery("#rating_worker").append(workerRate);
        ...
        function buildProviderRatingsAndReviewsHTML(bookingOrder, userreviewsnapshot) {
            var allreviewdata = [];
            var providerRate = '';
            ...
            allreviewdata.forEach((listval) => {
                ...
                var rating = 0;
                if (val.providerId != undefined && provider.id == val.productId) {
                    rating = val.rating;
                    providerRate = providerRate + '<span class="sp_badge badge badge-success text-white ml-auto" ><i class=" fstar fa fa-star" ></i>' + (rating) + '</span>';
                }
        ...
        function buildWorkerRatingsAndReviewsHTML(bookingOrder, userreviewsnapshot) {
            var allreviewdata = [];
            var workerRate = '';
            userreviewsnapshot.docs.forEach((listval) => {
                var reviewDatas = listval.data();
            ...
            allreviewdata.forEach((listval) => {
                ...
                if (val.providerId == undefined && provider.id == val.productId) {
                    rating = val.rating;
                    workerRate = workerRate + '<span class="sp_badge badge badge-success text-white ml-auto" ><i class="fstar fa fa-star" ></i>' + (rating) + '</span>';
                }
        ...
        function buildRatingsAndReviewsHTML(bookingOrder, userreviewsnapshot) {
            ...
            allreviewdata.forEach((listval) => {
                ...
                if ((val.VendorId == " " || val.providerId == undefined) && val.driverId != "") 
                {
        ...
        function PrintElem(elem) {
            ...
            // Remove the order_status_div portion from the clone
            elemClone.find('#order_status_div').remove();

            elemClone.find("#extra_charge").remove();

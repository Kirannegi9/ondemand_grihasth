        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                        href="{!! route('bookings') !!}">{{trans('lang.booking_plural')}}</a>
                </li>
    ...
    <script>
        ...
        if((val.endTime != null && val.provider.priceUnit=='Hourly') || val.provider.priceUnit!='Hourly' ){
            ...
            if (intRegex.test(adminCommission) || floatRegex.test(adminCommission)) {
                ...
                $('.table-subtotal tr:eq(4)').after("<tr><td>{{trans('lang.admin_commission')}}<label style='color:red'>"+adminCommHtml + "</label></td><td>"+adminCommission+"</td></tr>");
            }

                ...
                <div class="text-center mb-4">
                    <a href="{{ url('/') }}" class="d-inline-block">
                        <img alt="Logo" class="img-fluid mx-auto"
                             src="{{ asset('img/logo_web.png') }}" id="logo_web"
                             style="max-height:80px; display:block;">
                    </a>
                </div>
                <h3 class="text-dark my-0 mb-3 text-center">{{trans('lang.login')}}</h3>
                <p class="text-50 text-center">{{trans('lang.sign_in_to_continue')}}</p>

...
<head>
    ...
    <title><?php echo env('APP_NAME'); ?> -Building Dreams, Delivering Trust</title>
    ...
    <!-- Store Status Indicators CSS (always applied) -->
    <style>
        .store-status {
            display: flex;
            align-items: center;
...
<?php /**PATH E:\ondemand_grihasth-master\ondemand_grihasth-master\resources\views/layouts/app.blade.php ENDPATH**/ ?>
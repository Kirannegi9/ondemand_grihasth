            ...
            <div class="col-10 mx-auto card p-3">
                <div class="text-center mb-4">
                    <a href="<?php echo e(url('/')); ?>" class="d-inline-block">
                        <img alt="Logo" class="img-fluid mx-auto"
                             src="<?php echo e(asset('img/logo_web.png')); ?>" id="logo_web"
                             style="max-height:80px; display:block;">
                    </a>
                </div>
                <h3 class="text-dark my-0 mb-3 text-center"><?php echo e(trans('lang.login')); ?></h3>
                <p class="text-50 text-center"><?php echo e(trans('lang.sign_in_to_continue')); ?></p>
                <form class="mt-3 mb-4" action="#" onsubmit="return loginClick()" id="login-box">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg btn-block"
                            id="login_btn"><?php echo e(trans('lang.log_in')); ?></button>
                    ...
                    <button type="button" onclick="loginWithPhoneClick()" id="loginphon_btn"
                        ...
                        <i class="fa fa-phone mr-2"> </i> <?php echo e(__('Login')); ?> <?php echo e(trans('lang.with_phone')); ?></button>
                </form>
                <form class="form-horizontal form-material" name="loginwithphon" id="login-with-phone-box" action="#"
                      style="display:none;">
                    <?php echo csrf_field(); ?>
                    <div class="box-title m-b-20"><?php echo e(__('Login')); ?></div>
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            ...
                            <button type="button" onclick="loginBackClick()"
                                    class="btn btn-dark btn-lg btn-block text-uppercase waves-effect waves-light btn btn-primary"><?php echo e(__('Login')); ?> <?php echo e(trans('lang.with_email')); ?></button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        firebase.auth().signInWithEmailAndPassword(email, password).then(function (result) {
            ...
            database.collection("users").where("email", "==", userEmail).get().then(async function (snapshots) {
                if (!snapshots.docs || snapshots.docs.length === 0) {
                    $("#password_required_new").html("<p>User not found. Please check your credentials.</p>");
                    return false;
                }
        ...
        window.confirmationResult.confirm(document.getElementById("verificationcode").value)
            .then(function (result) {
                database.collection("users").where('phoneNumber', '==', jQuery("#phone").val()).where("role", "==", 'customer').get().then(async function (snapshots_login) {
                    if (!snapshots_login.docs || snapshots_login.docs.length === 0) {
                        jQuery("#password_required_new").html("User not found. Please check your credentials.");
                        return false;
                    }
...
<?php /**PATH E:\ondemand_grihasth-master\ondemand_grihasth-master\resources\views/auth/loginuser.blade.php ENDPATH**/ ?>
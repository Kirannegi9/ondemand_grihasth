            ...
            <div class="modal-body">
                ...
                <form class="">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-12 form-group"><label class="form-label"><?php echo e(trans('lang.city')); ?></label><input placeholder="<?php echo e(trans('lang.city')); ?>" id="address_city" type="text" class="form-control">
    ...
    <div class="modal-dialog modal-dialog-centered notification-main" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary"><a href="<?php echo e(url('parcel_orders')); ?>" id="order_notification_url"><?php echo e(trans('lang.Go')); ?></a>

                </button>

                <?php } else if (@$_COOKIE['service_type'] == "Rental Service") { ?>

                <button type="button" class="btn btn-primary"><a href="<?php echo e(url('rental_orders')); ?>" id="order_notification_url"><?php echo e(trans('lang.Go')); ?></a>

                </button>

                <?php } else { ?>

                <button type="button" class="btn btn-primary"><a href="<?php echo e(url('my_order')); ?>" id="order_notification_url"><?php echo e(trans('lang.Go')); ?></a>
...
<script src="<?php echo e(asset('firebase-messaging-sw.js')); ?>" type="text/javascript"></script>
...
<?php /**PATH E:\ondemand_grihasth-master\ondemand_grihasth-master\resources\views/layouts/footer.blade.php ENDPATH**/ ?>
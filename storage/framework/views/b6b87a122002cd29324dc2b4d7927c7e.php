...
<div class="siddhi-home-page">
    ...
    <script type="text/javascript">
        ...
        async function getHomepageCategory() {
            ...
            for (let doc of homeCategoriesSnapshot.docs) {
                ...
                let category_route = "<?php echo e(route('productlist', [':type', ':id'])); ?>"
                ...
                <div class="category-content mb-5">
                    <div class="title d-flex align-items-center">
                        ...
                        <span class="see-all ml-auto"><a href="${category_route}"><?php echo trans('lang.see_all'); ?></a></span>
                    </div>
                    ${productHtml}
                </div>`;
                })());
    ...
    <?php echo $__env->make('layouts.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php /**PATH E:\ondemand_grihasth-master\ondemand_grihasth-master\resources\views/home_page/multivendor_home.blade.php ENDPATH**/ ?>
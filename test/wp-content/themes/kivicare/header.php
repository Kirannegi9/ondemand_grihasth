...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-5X8MDQP1VS"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-5X8MDQP1VS');
</script>
...
<body <?php body_class(); ?>>
  ...
  <div id="page" class="site <?php echo esc_attr($default_site_content);
    ...
    <header class="header-default<?php echo esc_attr($has_sticky); ?>" id="default-header">
        <div class="custom-top-bar">
          <div class="container">
            ...
            <div class="top-bar-center">
              <?php dynamic_sidebar( 'top-bar-center' ); ?>
            </div>
      ...
      <div class="container">
          <!--<?php echo esc_attr($kivicare_container); ?>-->
        <div class="row">
